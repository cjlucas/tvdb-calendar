defmodule TVDBCalendar.Endpoint do
  use Phoenix.Endpoint, otp_app: :tvdb_calendar

  socket "/socket", TVDBCalendar.UserSocket
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_tvdb_calendar_key",
    signing_salt: "wLBXD7J3"

  plug TVDBCalendar.Router
end
